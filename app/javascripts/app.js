...
window.App = {
    ...
    withdrawEther: function () {
        ...
        var amountEther = document.getElementById("inputAmountWithdrawEther").value;
        var exchangeInstance;
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            ...
            App.refreshBalanceExchange();
            document.getElementById("inputAmountWithdrawEther").value = "";
        }).catch(function (e) {
            console.log(e);
            App.setStatus("Error getting balance; see log.");
        })
    ...
    withdrawToken: function () {
        ...
        var nameToken = document.getElementById("inputNameWithdrawToken").value;
        var amountTokens = document.getElementById("inputAmountWithdrawToken").value;
        var exchangeInstance;
        ExchangeContract.deployed().then(function (instance) {
            exchangeInstance = instance;
            ...
            console.log("withdrawToken error" + e);
            App.setStatus("Error getting balance; see log.");
        });
    },
    ...
    listenToTradingEvents: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            exchangeInstance.SellOrderFulfilled({}, {
                ...
                argsBox.innerText = JSON.stringify(result.args);
                alertbox.appendChild(argsBox);
                document.getElementById("fullfilledorderEvents").appendChild(alertbox);
            });
    ...
    sendToken: function () {
        ...
        return TokenContract.deployed().then(function (instance) {
            ...
            console.log(e);
            self.setStatus("Error sending coin; see log.");  //todo check here: self or App?
        });
    },
