...
contract('Exchange Basic Tests', function (accounts) {
    ...
    it("should be possible to Deposit and Withdrawal Ether", function () {
        var myExchangeInstance;
        var balanceBeforeTransaction = web3.eth.getBalance(accounts[0]);  //total supply
        ...
        return exchange.deployed().then(function (instance) {
            ...
            assert.isAtLeast(balanceBeforeTransaction.toNumber() - balanceAfterDeposit.toNumber(), parseInt(web3.toWei(1, "ether")), "Balances of account are the same");
